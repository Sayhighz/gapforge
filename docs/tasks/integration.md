...
- [x] Test repair, malformed output, parallel-call cap, stale lease, and secret exclusion end to end.
  ...
  Progress: I4 completed and pushed at `a6c44ad` in draft PR #10. Exact validation:
  `pytest` 283 passed/1 skipped; Ruff check and format, mypy `src`, Alembic check, and
